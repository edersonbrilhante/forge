locals {
  ...
  terraform_aws_github_runner_tags = merge(
    ...
    {
      terraform-aws-github-runner-ref = "v7.10.2"
    }
  )
...
data "external" "download_lambdas" {
  program = ["bash", "${path.module}/scripts/download_lambdas.sh", "/tmp/${var.runner_configs.prefix}/", "v7.10.2", "github-aws-runners/terraform-aws-github-runner"]
}
...
module "runners" {
  ...
  source = "git::https://github.com/github-aws-runners/terraform-aws-github-runner.git//modules/multi-runner?ref=v7.10.2"
